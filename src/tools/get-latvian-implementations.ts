/**
 * get_latvian_implementations — Find Latvian statutes that reference a specific EU directive/regulation.
 */
...
export interface LatvianImplementationResult {
  document_id: string;
...
export async function getLatvianImplementations(
  db: InstanceType<typeof Database>,
  input: GetLatvianImplementationsInput,
): Promise<ToolResponse<LatvianImplementationResult[]>> {
  try {
