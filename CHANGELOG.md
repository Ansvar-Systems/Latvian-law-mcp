...
## [1.0.0] - 2026-02-21
### Added
- Initial release of Latvian Law MCP
- `search_legislation` tool for full-text search across Latvian legislation
...
- `get_latvian_implementations` tool for finding national EU implementations
...
[1.0.0]: https://github.com/Ansvar-Systems/Latvian-law-mcp/releases/tag/v1.0.0
